...
export const DICT: Record<Lang, Dict> = {
  fr: {
    ...
    vowelsRefused: 'mot(s) surligné(s) ci-dessous sont restés sans voyelles.',
  ...
  en: {
    ...
    vowelsRefused: 'highlighted word(s) below were left unvowelled.',
  ...
  ar: {
    ...
    vowelsRefused: 'كلمة مظلّلة أدناه تُركت بلا تشكيل.',
